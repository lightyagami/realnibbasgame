...
def _watch(bot: Bot, update, isTar=False):
    ...
    try:
        ...
        msg += f"\n\nExample:\n<code>/{BotCommands.WatchCommand} https://youtu.be/dQw4w9WgXcQ 720 |Venom</code>\n\n"
        msg += "This file will be downloaded in 720p quality and it's name will be <b>Venom</b>"
