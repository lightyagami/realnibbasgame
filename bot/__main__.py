...
from .modules import authorize, list, cancel_mirror, mirror_status, mirror, clone, watch, shell, eval, torrent_search, delete, speedtest, usage, count, reboot, updates
...
'''
    ...
    buttons.buildbutton("Repo", "https://github.com/venomsnake/vhascometo")
    #buttons.buildbutton("Channel", "https://t.me/")
    ...
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        ...
        sendMarkup(f"Oops! not a Authorized user.\nPlease deploy your own <b>mirrorbot</b>.", context.bot, update, reply_markup)
