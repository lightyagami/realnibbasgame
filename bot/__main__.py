...
def start(update, context):
    ...
    #buttons.buildbutton("Channel", "https://t.me/SnakeMirrorUpdates")
...
'''
        ...
        sendMarkup(
            'Oops! not a Authorized user.\nPlease deploy your own <b>Snake-mirrorbot</b>.',
            context.bot,
            update,
            reply_markup,
        )
...
help = Telegraph(access_token=telegraph_token).create_page(
        title='Snake Mirrorbot Help',
        author_name='Snake Mirrorbot',
        author_url='https://github.com/VenomSnake/Vhascometo',
